-- =============================================================================
-- FIX ROOMS ONLY — run this if you get "suite" / room_type check errors
-- Do NOT re-run the old schema with generate_series(1,26) or room type "suite".
-- Safe to run multiple times. Keeps staff, leave, punches, logins intact.
-- =============================================================================
...
-- Quick check — should return 32
SELECT property_id, count(*) FROM rooms GROUP BY property_id;
